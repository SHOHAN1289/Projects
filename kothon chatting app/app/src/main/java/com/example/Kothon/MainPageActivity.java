...
import com.example.Kothon.Chat.ChatListAdapter;
...
public class MainPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.Kothon.R.layout.activity_main_page);
        ...
        Button mLogout = findViewById(com.example.Kothon.R.id.logout);
        Button mFindUser = findViewById(com.example.Kothon.R.id.findUser);
    ...
    private void initializeRecyclerView() {
        ...
        mChatList= findViewById(com.example.Kothon.R.id.chatList);
